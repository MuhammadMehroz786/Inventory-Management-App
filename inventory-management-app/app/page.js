  ...
  const generateRecipeHandler = async (e) => {
    ...
    try {
      const response = await axios({
        ...
        method: 'post',
        data: {
          contents: [{ parts: [{ text: `Generate a short and easy recipe, with step by step instructions with each step in diffrent line and only using these ingredients: ${ingredients.join(', ')}` }] }],
        },
      });
